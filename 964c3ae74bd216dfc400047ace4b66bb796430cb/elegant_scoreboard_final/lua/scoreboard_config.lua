    ...
    Elegant_Score_Config.ServerName = 'Elegant DarkRP Scoreboard' -- The name displayed on top of the scoreboard.
    Elegant_Score_Config.WebsiteLink = 'ExhibitionRP.com' -- The link to your website. Don't put https or http. Just the bare link such as www.google.co.uk
    --Super Administrator
